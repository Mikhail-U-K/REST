...
class __$$_LoadedCopyWithImpl<$Res>
    extends _$AppStateCopyWithImpl<$Res, _$_Loaded>
...
class _$_Loaded implements _Loaded {
  const _$_Loaded({required final List<UserModel> users}) : _users = users;
...
abstract class _Loaded implements AppState {
  const factory _Loaded({required final List<UserModel> users}) = _$_Loaded;
